...
% load('C:\Users\Balu\Nextcloud\Documents\MA\Code\Kira_MSc_data\results.mat');
% f = fields(Results.IK.FINAL_PERSONALISEDTORSIONS_scaled_final);
% pel_vel = [];
% for i=1:length(f)
...
% save data
% save C:\Users\Balu\Nextcloud\Documents\MA\Code\Kira_MSc_data\participants_characteristics_2.mat part_char -v7.3
save C:\Users\Balu\Nextcloud\Documents\MA\Code\Kira_MSc_data\participants_velocity.mat pel_vel -v7.3