...
addpath(genpath(OpenSimToMatDir))
...
paths = {[kiraDataDir '\P01\pre\output automization'];
          [kiraDataDir '\P01\post\output automization'];
          [kiraDataDir '\P02\pre\output automization'];
          [kiraDataDir '\P02\post\output automization'];
          [kiraDataDir '\P03\pre\output automization'];
          [kiraDataDir '\P03\post\output automization'];
          [kiraDataDir '\P04\pre\output automization'];
          [kiraDataDir '\P04\post\output automization'];
          [kiraDataDir '\P05\pre\output automization'];
          [kiraDataDir '\P05\post\output automization'];
          [kiraDataDir '\TD01\output automization'];
          [kiraDataDir '\TD04\output automization'];
          [kiraDataDir '\TD06\output automization'];
          [kiraDataDir '\TD07\output automization']};
...
stoFile = [kiraDataDir '\P03\post\output automization\FINAL_PERSONALISEDTORSIONS_scaled_final\Dynamic08\Output\IK\IK.mot'];
frame_first_c3d_in_openSim_frame = get_frame_zero(stoFile);

% trial that first event - initial frame < intial frame
stoFile = [kiraDataDir '\P01\post\output automization\FINAL_PERSONALISEDTORSIONS_scaled_final\Dynamic08\Output\IK\IK.mot'];
frame_first_c3d_in_openSim_frame = get_frame_zero(stoFile);
